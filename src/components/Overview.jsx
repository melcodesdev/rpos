...
const Overview = () => {
    return (
        <section className='min-h-screen font-inter flex flex-col justify-center my-4'>
            <h1 className='text-2xl font-semibold mx-auto my-8'>Why <span className='text-fuchsia-500'>Rpos</span>? </h1>
            ...
            <div className='mx-4 my-4'>
                ...
                <hr className='w-1/3 mx-auto my-6' />
            </div>
