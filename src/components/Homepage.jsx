        ...
        <section className='h-screen flex flex-col'>
            ...
            <section className='font-inter flex flex-col justify-center items-center text-center mx-4 my-auto'>
                ...
                <div className='xs:flex xs:flex-col xl:flex-row text-base lg:text-lg font-semibold my-8'>
                    <button className='w-60 sm:w-96 xl:w-64 h-10 lg:h-12  bg-fuchsia-500 text-white rounded-3xl my-2 xl:mx-4'>Free 30-days trial</button>

                    <button className='w-60 sm:w-96 xl:w-64 h-10 lg:h-12 bg-black text-white rounded-3xl my-2 xl:mx-4'>Schedule a demo</button>
                </div>
            </section>

            <section className='w-screen h-20 xs:h-24 sm:h-32 flex flex-row overflow-x-scroll xl:overflow-x-hidden bg-neutral-100'>
                <div className='flex flex-row mx-8 my-4 items-center opacity-70 xl:mx-auto'>
                ...
                <div className='flex flex-row mx-8 my-4 pr-4 items-center opacity-70 xl:mx-auto'>
