...
const Pricing = () => {
    return (
        <section className='flex flex-col w-screen bg-gradient-to-b from-fuchsia-500 to-rose-400 font-inter'>
            ...
            <section>
                <div className='w-60 sm:w-3/5 lg:w-1/2 flex flex-col text-white border-2 border-white rounded-lg lg:rounded-3xl mx-auto p-2 sm:p-8'>
                    ...
                    <button className='w-52 sm:w-80 lg:w-96 h-8 sm:h-10 bg-white rounded-md text-sm sm:text-lg text-black font-medium mx-auto my-2'>Get started</button>
                ...
                <div className='w-60 sm:w-3/5 lg:w-1/2 flex flex-col text-white border-4 border-white rounded-lg lg:rounded-3xl mx-auto my-8 p-2 sm:p-8'>
                ...
                <div className='w-60 sm:w-3/5 lg:w-1/2 flex flex-col text-white border-2 border-white rounded-lg lg:rounded-3xl mx-auto mt-8 mb-16 p-2 sm:p-8'>
