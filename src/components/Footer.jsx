...
const Footer = () => {
  return (
    <section className='m-4 xs:mx-16 text-xs sm:text-base lg:text-lg opacity-50'>
      <div className='flex flex-row justify-between my-2 sm:my-4'>
        <h4>Features</h4>
        <h4>Testimonials</h4>
        <h4>Pricing</h4>
        <h4>Contact</h4>
      ...
      <div className='flex flex-row justify-between my-2 sm:my-4 lg:my-8'>
        <h4>Rpos, Inc. 2023</h4>
